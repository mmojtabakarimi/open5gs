...
{
    OpenAPI_sm_policy_snssai_data_t *sm_policy_snssai_data_local_var = OpenAPI_malloc(sizeof(OpenAPI_sm_policy_snssai_data_t));
    if (!sm_policy_snssai_data_local_var) {
        return NULL;
    }
