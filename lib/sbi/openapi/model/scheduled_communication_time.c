...
{
    OpenAPI_scheduled_communication_time_t *scheduled_communication_time_local_var = OpenAPI_malloc(sizeof(OpenAPI_scheduled_communication_time_t));
    if (!scheduled_communication_time_local_var) {
        return NULL;
    }
