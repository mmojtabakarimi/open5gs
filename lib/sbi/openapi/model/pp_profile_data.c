...
{
    OpenAPI_pp_profile_data_t *pp_profile_data_local_var = OpenAPI_malloc(sizeof(OpenAPI_pp_profile_data_t));
    if (!pp_profile_data_local_var) {
        return NULL;
    }
...
OpenAPI_pp_profile_data_t *OpenAPI_pp_profile_data_parseFromJSON(cJSON *pp_profile_dataJSON)
{
    ...
    cJSON *allowed_mtc_providers = cJSON_GetObjectItemCaseSensitive(pp_profile_dataJSON, "allowedMtcProviders");
